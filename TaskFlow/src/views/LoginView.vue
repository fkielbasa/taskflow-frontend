  ...
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-sky-600 hover:text-cyan-500">Forgot password?</a>
            </div>
          </div>
          <div class="mt-1">
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        <RouterLink to="/register" class="font-semibold leading-6 text-sky-600 hover:text-cyan-500">Register now!</RouterLink >
      </p>
    </div>
  </div>
</template>

<template>
  <main id="Home" class="flex justify-evenly items-center bg-background-home min-h-screen">
    <div class="m-0 w-96 flex flex-col gap-20">
      ...
      <button class="bg-blue px-10 py-2 rounded-sm text-white font-bold">Zacznij już teraz po przez założenie konta</button>
      </div>
    <div>
